...
class Product extends ActiveRecord
{
    ...
    public static function create($brandId, $categoryId, $code, $name, $name_uk, $slug, $description, $description_uk, $quantity, Meta $meta): self
    {
        $product = new Product();
    ...
    public function edit($brandId, $code, $name, $name_uk, $slug, $description, $description_uk, Meta $meta): void
    {
