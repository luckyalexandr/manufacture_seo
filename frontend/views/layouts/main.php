...
<meta name="facebook-domain-verification" content="g8zi1ylq6h8o7xp33gup7evcr6idf3" />

<!-- Global site tag (gtag.js) - Google Analytics -->

<script async src="https://www.googletagmanager.com/gtag/js?id=UA-182896487-1"></script>
...
fbq('init', '939769606588563');
fbq('track', 'PageView');
</script>
<noscript><img height="1" width="1" style="display:none"
src="https://www.facebook.com/tr?id=939769606588563&ev=PageView&noscript=1"
/></noscript>
    ...
    <div class="sub-header col-xs-12 col-sm-8 col-md-8 col-lg-8">
        ...
        <div class="sub-header__top">
            ...
            <nav class="sub-header__top_social">
                <ul>
                    <li>
                        <a href="https://www.instagram.com/manufacture_17" target="_blank">
                            <img src="/uploads/social_icons/instagram.png" alt="Instagram">
                        </a>
                    </li>
                    <li>
                        <a href="https://www.facebook.com/Tkani.Manufacture17" target="_blank">
